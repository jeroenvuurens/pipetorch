...
def dam_outflow():
    return DFrame.read_from_package('pipetorch', 'data/datasets/dam_outflow.csv')
...
def iris():
    return DFrame.read_from_kaggle('uciml/iris')
...
def titanic():
    return DFrame.read_from_kaggle_competition('titanic', 'train.csv', 'test.csv')
...
def ames_housing():
    return DFrame.read_from_kaggle_competition('house-prices-advanced-regression-techniques', 'train.csv', 'test.csv')
    
def air_passengers():
    return DFrame.read_from_kaggle('rakannimer/air-passengers')

def rossmann_store_sales():
    return DFrame.read_from_kaggle_competition('rossmann-store-sales', 'train.csv', 'test.csv')

def rossmann_stores():
    return DFrame.read_from_kaggle_competition('rossmann-store-sales', 'store.csv')
